...
export default function EnquiryForm() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      const whatsappUrl = `https://wa.me/919972394416?text=${encodeURIComponent(
        message
      )}`;
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="section-subtitle max-w-2xl mx-auto">
              ...
              possible. You&apos;ll be redirected to WhatsApp for instant
              communication.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-12">
            ...
            <a
              ...
              className="bg-gradient-to-br from-green-500 to-green-700 text-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow group"
            >
              <MessageCircle className="w-8 h-8 mb-3 group-hover:scale-110 transition-transform" />
              <h3 className="text-lg font-bold mb-1">WhatsApp Us</h3>
              <p className="text-green-100">+91 9972394416</p>
            </a>
